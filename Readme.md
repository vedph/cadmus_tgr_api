...
docker buildx build . --platform linux/amd64,linux/arm64,windows/amd64,windows/arm64 -t vedph2020/cadmus-tgr-api:8.0.6 -t vedph2020/cadmus-tgr-api:latest --push
```
...
- 2025-08-08:
  - updated packages.
  - added Cadmus export controller.
