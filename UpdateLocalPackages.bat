...
xcopy %src%cadmus.tgr.services\1.0.3\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.tgr.parts\1.0.2\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.tgr.parts\1.0.2\*.nupkg .\local-packages\ /y
