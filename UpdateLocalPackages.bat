...
xcopy %src%cadmus.tgr.parts\1.0.9\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.tgr.parts\1.0.10\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.tgr.services\1.0.15\*.nupkg .\local-packages\ /y
